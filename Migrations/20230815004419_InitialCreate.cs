        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPremium = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    AvatarImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "https://localhost:7042/user.png"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfDownloads = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SocialMediaLinks_Link", "[Link] != ''");
                    table.ForeignKey(
